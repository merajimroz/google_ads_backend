...
records = []
def get_account_list(client, login_customer_id=None):
...
def print_account_hierarchy(
    ...
    records.append({
        ...
        'descriptiveName': customer_client.descriptive_name,
        'currencyCode': customer_client.currency_code, 
        'timeZone': customer_client.time_zone
        })
